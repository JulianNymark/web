import { H2, Squish, Text } from "@/components/monolith";
...
const Render = () => {
  return (
    <VStack>
      ...
      <Squish>
        <Text>
          So my thinking is to maybe have some sort of CMS (probably strapi),
          and then to use that for this blogs content (for starters). Thinking
          that could be a nice replacement for my old WP blog.
        </Text>
        <Text>
        ...
        <List title="Points against CMS:">
          ...
          <ListItem>
            kinda KISS for a blog with no two-way communication to simply
